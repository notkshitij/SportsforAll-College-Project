...
export function decodeAndVerifySecureQRPayload(
  ...
  console.log('[guard-app qrUtils] Raw Text to decode:', rawText);
  ...
  console.log('[guard-app qrUtils] Normalized Text:', text);
  ...
  try {
    ...
    console.error('[guard-app qrUtils] URLSearchParams parse error:', e?.message);
    return {
      isValidFormat: false,
      scanResult: 'invalid',
  ...
  console.log('[guard-app qrUtils] Parsed Fields:', { bookingId, type, exp, sig });
